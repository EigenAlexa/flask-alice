...
class CollectionData(object):
    ...
    def change_data(self, collection, id, fields, cleared):
        ...
        try:
            ...
            print('Key Error trying to update data', sys.exc_info())
            print('\ton self.data[{}][{}][{}]'.format(collection, id, key))
            print('\tin call `change_data({},{},{},{})`'.format(collection, id, fields, cleared))
            print('\twith data, {}'.format(self.data))
